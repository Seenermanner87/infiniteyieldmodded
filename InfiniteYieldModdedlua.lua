...
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy / remote2script', DESC = 'Opens Remote2Script V2'}
...
addcmd('remotespy',{'rspy', 'remote2script'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Seenermanner87/remote2scriptbackup/refs/heads/main/remote2script.lua"))()
    wait(2)
    notify("Loaded!",'Remote2Script made by N3xul')
end)
